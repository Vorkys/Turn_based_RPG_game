...
namespace tahova_RPG_hra.Source.Entities
{
    internal class Enemy : Entity
    {
        ...
        public Enemy(string name, string[] sprite, Item[] inventory, Item[] equipment, int level, int entityXP, int xPtoLevelUp, int health, int maxHealth, int mana, int maxMana, Spell[] spells, int damage, int armor, int speed, Status[] statuses, string[] entryDialog, string[] leaveDialog, int? money, Item[] drops, int escapeChance) : base(name, sprite, inventory, equipment, level, entityXP, xPtoLevelUp, health, maxHealth, mana, maxMana, spells, damage, armor, speed, statuses, entryDialog,leaveDialog, money)
        {
            this.drops = drops;
